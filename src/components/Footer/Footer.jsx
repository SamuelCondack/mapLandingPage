            ...
            <div className={styles.footerContainer}>
                ...
                <div className={styles.socials}>
                    ...
                    <div className={styles.socialIcons}>
                        <a href="https://www.instagram.com/map_marketplaces/" target="_blank"><img className={styles.socialImages} src={instagramLogo} alt="instagram logo" /></a>
                        <a href="https://www.linkedin.com/company/mapmarketplaces/mycompany/" target="_blank"><img className={styles.socialImages} src={linkedinLogo} alt="linkedin logo" /></a>
                    </div>
                </div>
            </div>
